...
echo.
echo 1. Caricamento index.html aggiornato...
...
echo - Gallery: Mostra TUTTE le foto caricate dall'admin
echo - Home: Rimosso secondo bottone, solo "Dettagli"
echo - Layout: Gallery responsive con grid adattiva
