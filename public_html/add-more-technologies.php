<?php
// Script per aggiungere più tecnologie al database
...
try {
    ...
    foreach ($newTechnologies as $tech) {
        ...
        $stmt = $pdo->prepare("SELECT id FROM technologies WHERE name = ? OR slug = ?");
        $stmt->execute([$tech['name'], $slug]);
        ...
        $stmt = $pdo->prepare("
            INSERT INTO technologies (
                name, slug, icon, color, category, proficiency_level, 
